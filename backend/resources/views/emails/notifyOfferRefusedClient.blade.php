                ...
                <tr>
                    <td colspan="4" style="padding: 40px 30px 20px 30px; text-align: center;">
                        ...
                        <p style="margin: 10px 0 0 0; font-size: 16px; color: #cccccc;">
                            Sajnáljuk, hogy nem nyerte el tetszését a kiállított ajánlat. Reméljük a jövőben viszont látni egymást.
                        </p>

                        <p style="margin: 10px 0 0 0; font-size: 15px; opacity: 0.7; color: #cccccc;">
                            Quotiva csapata
                        </p>
                    </td>
                </tr>
